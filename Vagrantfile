...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
	...
	config.vm.define "tornado" do |tornado|
		tornado.vm.box = "ubuntu/trusty64"
		tornado.vm.network :private_network, ip: "192.168.33.12"

		tornado.vm.provision :ansible do |ansible|
			ansible.playbook = "tornado.yml"
			ansible.groups = {
				  "tornado" => ["machine3"]
				}
			ansible.limit = "all"
